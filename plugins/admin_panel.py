...
async def tutorial(bot,message):
	...
	await message.reply_text(
	    ...
	    reply_markup=InlineKeyboardMarkup([
        			...
        			InlineKeyboardButton("⚡ Tutorial",url = "https://t.me/missqueenbotzchat") ]])
	)
...
￼Enter        os.execl(sys.executable, sys.executable, *sys.argv)
...
t.on_message(filters.command("broadcast") & filters.user(Config.ADMIN) & filters.reply)
async def broadcast_handler(bot: Client, m: Message):
    await bot.send_message(Config.LOG_CHANNEL, f"{m.from_user.mention} or {m.from_user.id} Is Started The Broadcast......")
    all_users = await madflixbotz.get_all_users()
    broadcast_msg = m.reply_to_message
